...
class LedgersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ledger" do
    assert_difference('Ledger.count') do
      post ledgers_url, params: { ledger: { cart_id: @ledger.cart_id, product_id: @ledger.product_id, times_bought: @ledger.times_bought } }, as: :json
    end
  ...
  test "should update ledger" do
    patch ledger_url(@ledger), params: { ledger: { cart_id: @ledger.cart_id, product_id: @ledger.product_id, times_bought: @ledger.times_bought } }, as: :json
    assert_response 200
  end
